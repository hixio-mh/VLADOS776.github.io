var Translation = {
    ...
    translation: {
        ...
        cases: {
            news: {
                text: '<p>Граффити! Можно использовать в чате.</p><p>Новые  ножи <a href="#" data-toggle="modal" data-target="#modal-knives">здесь</a>. Могут выпасть с Chroma кейсов.</p><p>Инвентарь:<br>Нажмите на предмет и держите, чтобы зайти в режим выделения.<br>Свайпните в лево или в право, чтобы увидеть другие предметы</p>'
            },
            page_name: {
                text: 'Открыть кейсы',
                en: 'Open Cases'
