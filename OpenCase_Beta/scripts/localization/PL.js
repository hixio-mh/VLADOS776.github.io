    ...
    translation: {
        ...
        dice: {
            ...
            game: {
                ...
                end_roll: {
                    text: 'Rzucono ${1}. Rzucic ponownie?',
        ...
        statistic: {
            ...
            total_opened: {
                text: 'Wszystkie skrzynie otworzone',
            ...
            jackpot_win_lose: {
                text: 'Jackpot wygrane/przegrane',
                en: 'Jackpot win/lose'
            },
            jackpot_max: {
        ...
        faq: {
            ...
            why_no_price: {
                title: {
                    text: 'Dlaczego cena broni wynosi $0?',
        ...
        settings: {
            ...
            interface: {
                ...
                fast_drop: {
                    text: 'Szybsze otwieranie skrzynki',
                    en: 'Fast drop (x2)'
                }
            },
            reset: {
